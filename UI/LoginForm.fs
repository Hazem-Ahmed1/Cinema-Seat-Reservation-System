...
type LoginForm() as this =
    ...
    do
        ...
        let registerLinkLabel = new Label(
        ...
        loginButton.Click.Add(fun _ ->
            ...
            | Error msg -> 
                MessageBox.Show(msg, "Login Failed", MessageBoxButtons.OK, MessageBoxIcon.Error) |> ignore
        )
        ...
        registerLinkLabel.Click.Add(fun _ ->
            ...
            if registerForm.ShowDialog() = DialogResult.OK then
                MessageBox.Show("Registration Successful! Please login.", "Info", MessageBoxButtons.OK, MessageBoxIcon.Information) |> ignore
